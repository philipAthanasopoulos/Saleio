...
public class ParserTest {
	...
	public void testParseAssociateFromFile() {
		...
		try {
			...
			Associate associate6 = parserHTML.parseAssociateFromFile(testCase2HTML);
			...
			assertEquals(associate6.getReceipts().size(), 4);
			...
			assertEquals(associate6.getPersonalFile(), testCase2HTML);
