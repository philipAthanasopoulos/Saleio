...
public class XMLParser extends Parser {
    ...
    public void readFile() {
        try {
			...
			Node afmNode = document.getElementsByTagName("AFM").item(0);
			afm = afmNode.getTextContent();
	...
	public static void main(String[] args) {
		File file = new File("C:\\Users\\Philip\\Desktop\\UOI\\SD2\\soft-devII-2024\\soft-devII-2024-project-material\\sales-commissions-application\\resources\\test-case-2-XML.xml");
